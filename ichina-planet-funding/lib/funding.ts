...
export const fundingSnapshot = {
  ...
  desk: fundingDesk.id,
  product: fundingDesk.product,
  productNote:
    "Official title: Walk a real city as a tiny planet — jubuddy. Live surface. Do not invent MAU, revenue, or a raise number.",
  dualTrack: fundingDesk.dualTrack,
  thesis:
    "Prefer less-burden halo capital that also brings distribution or operator help: CityU alumni seed, then Cyberport grant/incubate, then named HK portals. This file is the product-funding desk only.",
  thesisZh:
    "先低负担光环资本，再要渠道或操盘手资源：城大校友种子，然后数码港资助/孵化，然后具名香港门户。本文件只服务产品融资台面。",
  drafts: {
